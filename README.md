...
<hr>
 ...
 <b>موضوع : Data Type ها در پایگاه داده  - تحقیق شماره 7</b>

 
 تصور کنید که پایگاه داده شما مثل یک کمد لباس است. هر نوع داده مثل یک نوع لباس است و هر لباس فضای خاص خودش را اشغال می‌کند. انتخاب نوع درست لباس (داده) برای هر قفسه (فیلد) به شما کمک می‌کند تا کمدتان (پایگاه داده) را مرتب و منظم نگه دارید و از فضای آن به بهترین نحو استفاده کنید.
 
 <b>
  
اندازه هر نوع لباس (داده):

</b>



<div dir="rtl">Bit: مثل یک تی‌شرت نازک، فقط برای دو حالت درست و غلط (true/false) جا دارد.</div>
<br>

<div dir="rtl">TINYINT: مثل یک شلوار جین کم‌رنگ، برای اعداد صحیح کوچکی بین 128- تا 127 جا دارد.</div>
<br>

<div dir="rtl">SMALLINT: مثل یک پیراهن، برای اعداد صحیح بین 32,768- تا 32,767 جا دارد.</div>
<br>

<div dir="rtl">INT: مثل یک کاپشن زمستانی، برای اعداد صحیح بین 2,147,483,648- تا 2,147,483,647 جا دارد.</div>
<br>

<div dir="rtl">BIGINT: مثل یک چادر مسافرتی، برای اعداد خیلی بزرگ بین 9,223,372,036,854,775,808- تا 9,223,372,036,854,775,807 جا دارد.</div>
<br>

<div dir="rtl">FLOAT: مثل یک بلوز، برای اعداد اعشاری با 7 رقم بعد از اعشار جا دارد.</div>
<br>

<div dir="rtl">DOUBLE: مثل یک کت، برای اعداد اعشاری با 15 رقم بعد از اعشار جا دارد.</div>
<br>

<div dir="rtl">DECIMAL: مثل یک لباس سفارشی، برای اعداد اعشاری با دقت و تعداد ارقام دلخواه جا دارد.</div>
<br>

<div dir="rtl">CHAR: مثل یک ردیف از قفسه‌ها با اندازه ثابت، برای رشته‌های متنی با طول ثابت (هر حرف 1 یا 2 بایت) جا دارد.</div>
<br>

<div dir="rtl">VARCHAR: مثل یک کشوی جادویی، برای رشته‌های متنی با طول متغیر (هر حرف 1 یا 2 بایت) جا دارد.</div>
<br>

<div dir="rtl">TEXT: مثل یک کتاب ضخیم، برای متن‌های خیلی بلند (تا 4000 حرف) جا دارد.</div>
<br>

<div dir="rtl">BLOB: مثل یک چمدان، برای اطلاعات دودویی مثل عکس و فایل (با اندازه متغیر) جا دارد.</div>
<br>

<div dir="rtl">DATE: مثل یک تقویم، برای تاریخ‌ها جا دارد.</div>
<br>

<div dir="rtl">TIME: مثل یک ساعت، برای زمان‌ها جا دارد.</div>
<br>

<div dir="rtl">DATETIME: مثل یک تقویم و ساعت دقیق، برای تاریخ و زمان با دقت بالا جا دارد.</div>
<br>

<div dir="rtl">TIMESTAMP: مثل یک ساعت اتمی، برای تاریخ و زمان با دقت خیلی بالا جا دارد.</div>
<br>

<b>


انتخاب لباس مناسب (داده):
</b>

محدوده اندازه: لباسی (داده‌ای) را انتخاب کنید که به اندازه کافی بزرگ باشد تا تمام مقادیر مورد نظرتان را در خود جای دهد.

دقت: دقت لباس (داده) را به اندازه ای انتخاب کنید که جزئیات مورد نظرتان را نشان دهد.

فضای ذخیره: از لباس‌های (داده‌های) بزرگتر از حد نیاز استفاده نکنید، چون فضای زیادی اشغال می‌کنند.

سرعت: لباسی (داده‌ای) را انتخاب کنید که به شما کمک کند تا به سرعت به اطلاعات مورد نیازتان دسترسی پیدا کنید.

نکات:

از لباس‌های (داده‌های) بزرگتر از حد نیاز استفاده نکنید.

تا حد امکان از لباس‌های (داده‌های) استاندارد استفاده کنید.

در صورت نیاز از لباس‌های (داده‌های) خاص استفاده کنید.
</div>
